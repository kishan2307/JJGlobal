...
<div class="row">
	...
	<div class="row ft-bg-img ft-ct">
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ft-block">
			...
			<div class="prodTag">
			   <a href="products?id={{prod.id}}&cat={{prod.product_cat}}" ng-repeat="prod in products track by $index" ng-show="prod.active=='1' && $index<10">{{prod.name}}</a>
                           <a href="products?cat=4">Mining Machinery</a>
                           <a href="products?cat=5">Agricultural Machinery</a>			
			</div>
		</div>
