                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown" data-page="aproduct">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="product?name=Agricultural Machinery">Agricultural Machinery</a></li>							
                            <li><a href="product?name=Mining Machinery">Mining Machinery</a></li>							
                        </ul>
                    </li>
                    ...
                    <li class="dropdown" data-page="product">
                        ...
                        <ul class="dropdown-menu">
                            <li ng-repeat="prod in products" ng-if="prod.product_cat=='2'"><a href="product?id={{prod.id}}&&type={{prod.type}}">{{prod.name}}</a></li>                            								
                        </ul>
                    </li>
